...
summary_columns = ['Iteration', 'mean', 'mean_g1', 'mean_g2', 'mean_g3', 'mean_g4', 'mean_G', 'count_g1', 'count_g2', 'count_g3', 'count_g4', 'count_G', 'changes']
...
tmp = summary_data[['count_g1', 'count_g2', 'count_g3', 'count_g4', 'count_G']]
tmp.columns = ['market_1', 'market_2', 'market_3', 'market_4', 'market_5 (S)']
...
ax.set_xlabel('Round')
plt.savefig('art_gov_Number_Iter.png', bbox_inches='tight', dpi = 300)
plt.show()

# plot2 - Profits vs Round
tmp = summary_data[['mean', 'mean_g1', 'mean_g2', 'mean_g3', 'mean_g4', 'mean_G']]
tmp.columns = ['Total', 'market_1', 'market_2', 'market_3', 'market_4', 'market_5 (S)']
...
ax.set_xlabel('Round')
plt.savefig('art_gov_Profit_Iter.png', bbox_inches='tight', dpi = 300)
plt.show()
...
ax.set_xlabel('Round')
plt.savefig('art_gov_Decision_chg.png', bbox_inches='tight', dpi = 300)
plt.show()
...
plt.savefig('art_gov_Profits_chg.png', bbox_inches='tight', dpi = 300)
plt.show()
...
def plot_iter(iter, results_profits):
    ...
    # plot1 - Num of agents vs Round
    tmp = round_data[['count_g1', 'count_g2', 'count_g3', 'count_g4', 'count_G']]
    tmp.columns = ['market_1', 'market_2', 'market_3', 'market_4', 'market_5 (S)']
    ...
    ax.set_ylabel('Number of agents')
    ax.set_xlabel('Round')
    plt.savefig('art_gov_Num_Iter_' + str(iter) + '.png', bbox_inches='tight', dpi = 300)
    plt.show()

    #plot2 - Profits on market vs Round

    tmp = round_data[['mean', 'mean_g1', 'mean_g2', 'mean_g3', 'mean_g4', 'mean_G']]
    tmp.columns = ['Total', 'market_1', 'market_2', 'market_3', 'market_4', 'market_5 (S)']
    ...
    plt.savefig('art_gov_Profit_Iter_' + str(iter) + '.png', bbox_inches='tight', dpi = 300)
    plt.show()
...
max_iter = 13 # max number of subsidies in Round > 900
min_iter = 92 # min number of subsidies in Round > 900

plot_iter(int(max_iter), results_profits.copy())
plot_iter(int(min_iter), results_profits.copy())
